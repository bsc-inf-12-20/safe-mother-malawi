...
const List<NavItem> _navItems = [
  ...
  NavItem(label: 'Insights', icon: Icons.insights_rounded, route: '/insights', allowedRoles: [UserRole.admin, UserRole.dho]),
  NavItem(label: 'Activity Logs', icon: Icons.history_rounded, route: '/activity-logs', allowedRoles: [UserRole.admin]),
...
class AppSidebar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final visible = _navItems.where((i) => i.allowedRoles.contains(role)).toList();
